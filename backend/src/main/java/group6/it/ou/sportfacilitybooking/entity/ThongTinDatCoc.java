...
public class ThongTinDatCoc {
    ...
    // ==========================================
    public ThongTinDatCoc() {
    }

    // ==========================================
    // Constructor tất cả tham số (AllArgsConstructor)
    // ==========================================
    public ThongTinDatCoc(Integer maDatCoc, BigDecimal tienCoc, String phuongThucThanhToan,
                          PaymentStatus tinhTrangThanhToan, LocalDateTime ngayThanhToan,
                          ThongTinDatSan thongTinDatSan) {
    ...
    public ThongTinDatSan getThongTinDatSan() {
    ...
    public void setThongTinDatSan(ThongTinDatSan thongTinDatSan) {
        this.thongTinDatSan = thongTinDatSan;
    }
    ...
    public static class Builder {
        ...
        public Builder thongTinDatSan(ThongTinDatSan thongTinDatSan) {
            this.thongTinDatSan = thongTinDatSan;
            return this;
        }

        public ThongTinDatCoc build() {
            return new ThongTinDatCoc(maDatCoc, tienCoc, phuongThucThanhToan,
